...
namespace Moneyon.PowerBi.Infrastructure.Migrations
{
    ...
    [Migration("20240114074545_Ticket01")]
    partial class Ticket01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.Document", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.DocumentContent", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.Package", b =>
                {
                    ...
                    b.Property<bool>("IsSuperiorDiscount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.TicketCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.TicketDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.IpgPayment", b =>
                {
                    b.HasBaseType("Moneyon.PowerBi.Domain.Modeling.Payment");

                    b.ToTable("Payments");

                    b.HasDiscriminator().HasValue("IpgPayment");
                });

            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.ReceiptPayment", b =>
                {
                    b.HasBaseType("Moneyon.PowerBi.Domain.Modeling.Payment");
                    ...
                    b.Property<string>("ReceiptPayerName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasDiscriminator().HasValue("ReceiptPayment");
                });
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.Document", b =>
                {
                    ...
                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.TicketDetail", "TicketDetail")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.DocumentContent", b =>
                {
                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.Document", "Document")
                        .WithOne("Content")
                        .HasForeignKey("Moneyon.PowerBi.Domain.Model.Modeling.DocumentContent", "Id")
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.Ticket", b =>
                {
                    b.HasOne("Moneyon.PowerBi.Domain.Modeling.Person", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Moneyon.PowerBi.Domain.Modeling.Person", "LastUserModified")
                        .WithMany()
                        .HasForeignKey("LastUserModifiedId");

                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.TicketCategory", "TicketCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.TicketCategory", b =>
                {
                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.TicketCategory", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.TicketDetail", b =>
                {
                    ...
                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.Ticket", "Ticket")
            ...
            modelBuilder.Entity("Moneyon.PowerBi.Domain.Model.Modeling.ReceiptPayment", b =>
                {
                    b.HasOne("Moneyon.PowerBi.Domain.Model.Modeling.Document", "Image")
                        .WithOne()
                        .HasForeignKey("Moneyon.PowerBi.Domain.Model.Modeling.ReceiptPayment", "ImageId")
